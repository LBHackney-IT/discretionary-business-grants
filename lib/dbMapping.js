...
export const COMPANY_STRUCTURE = ['Charity', 'Partnership', 'Registered company', 'Social enterprise', 'Sole trader'];
...
export const STATE_AID_OPTION = ['Not Applicable', 'Covid 19 Temporary Framework Scheme', 'State Aid De Minimis Rule'];

export const STATE_AID_OPTION_WITH_MORE_Q = ['Covid 19 Temporary Framework Scheme', 'State Aid De Minimis Rule'];
