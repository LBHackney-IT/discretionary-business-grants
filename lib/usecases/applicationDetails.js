  ...
  return {
    application: {
      ...
      eligibilityCriteria: {
        ...
        hasFixedPropertyCost: booleanToYesNo(application.has_fixed_property_cost),
        significantIncomeFall: booleanToYesNo(application.significant_income_fall)
      },
      contact: {
      ...
      business: {
        companyStructureId: COMPANY_STRUCTURE[application.company_structure_id - 1],
        ...
        siteDescriptionId: SITE_DESCRIPTION[application.site_description_id - 1],
      ...
      documents: getDocuments(dbInstance, clientGeneratedId),
      businessBankAccount: {
      ...
      declaration: {
        ...
        dateOfAid: application.date_of_aid ? new Date(application.date_of_aid).toISOString() : null,
        ...
        permittedToAcceptStateAidGrant: booleanToYesNo(application.permitted_to_accept_state_aid_grant),
        readUnderstoodDeclaration: booleanToYesNo(application.read_understood_declaration)
      }
    }
  };
};
