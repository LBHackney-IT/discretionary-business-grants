  ...
  return {
    application: {
      ...
      contact: {
        ...
        address: {
          uprn: application.uprn,
          firstLine: application.first_line,
          secondLine: application.second_line,
          thirdLine: application.third_line,
      ...
      business: {}, // Todo
      turnover: {}, // Todo
      fixedPropertyCosts: {}, // Todo
      documents: {}, // Todo
      businessBankAccount: {}, // Todo
      declaration: {} // Todo
    }
  };
};
