...
export default async ({
  ...
  try {
    ...
    const businessId = await db.one(
      ...
      (grant_application_id, company_structure_id, company_name, description, company_number, nndr_account_number, full_time_employees, annual_turnover, percent_fall_in_income, rateable_value, fixed_property_cost, rates_account_number, registered_charity)
